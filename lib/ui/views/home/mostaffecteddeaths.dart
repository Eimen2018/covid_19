...
class MostAffectedDeaths extends HookViewModelWidget<HomeViewModel> {
  MostAffectedDeaths({
    Key key,
        ...
        CarouselSlider(
          options: CarouselOptions(
              ...
              onPageChanged: (index, reason) {
                model.changePageindicator(index, 1);
              }),
          items: (model.mostAffected == null)
              ? [
                  Container(
              ...
              : [
                  ...
                  MostAffected(
                    type: "Highest Fatal By\nCountry",
                    name: "Deaths",
                    color: Colors.red,
                    countryData: model.mostAffectedYesterday,
                    setCountry: model.setcountry,
                    updateData: model.fetchcountryData,
                    date: 'Yesterday',
                  ),
          ...
          children: [1, 2].map((url) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                color: model.pageIndicator == index
